...
Public Class SDD131
    ...
    Private Sub print()
        ...
        'SDD131.ReportView.LoadView("SDD131", "", "SDD130_Print", p)
    ...
    'Private Sub btn_jump_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
