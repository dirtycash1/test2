...
Public Class GAD120
    ...
    Private Sub btn_all_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_all.CheckedChanged

        g10.CheckRows("ok_yn", btn_all.Checked)
