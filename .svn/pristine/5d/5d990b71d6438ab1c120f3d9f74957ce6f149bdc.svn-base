        ...
        Select Case mty
            ...
            Case MenuType.Save
                If Me.Save() Then
                    ...
                    param.Add("@mgt_no", g10.Text("mgt_no"))
                    Me.Open("qma360_g20", param)
                End If
    ...
    Private Sub g20_ButtonPressed(sender As System.Object, columnName As System.String) Handles g20.ButtonPressed
        ...
        If columnName = "file_add" Then
            ...
            If dialog.ShowDialog() = DialogResult.OK Then
                ...
                fileName = dialog.FileName.Replace(dialog.SafeFileName, g10.Text("mgt_no") + "_" + g20.Text("seq") + "_" + dialog.SafeFileName)

                System.IO.File.Copy(dialog.FileName, fileName, True)
                tempFileName = [Shared].FileUpload("", fileName, "QMA360")
        ...
        ElseIf columnName = "file_del" Then
            If [Shared].FileDelete(g20.Text("file_view"), "QMA360") Then
                g20.Text("file_add") = ""
                g20.Text("file_view") = ""
                g20.Text("file_del") = ""
            End If
    ...
    Private Sub g10_BeforeMoveRow(sender As System.Object, RowIndex As System.Int32, ByRef AllowMove As System.Boolean) Handles g10.BeforeMoveRow
        ...
        If isChanged = True Then
            Dim dResult As DialogResult =
                MessageBox.Show("다른 시험설비 검교정내역을 등록 하시려면 현재 입력한 검교정 내역을 저장해야 합니다. 지금 저장 하시겠습니까?",
