...
Public Class FAR250
    ...
    Private Sub btn_work_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_work.Click
        ...
        If MessageYesNo("[비용계산]작업을 진행하시겠습니까?") <> MsgBoxResult.Yes Then Exit Sub
    ...
    Private Sub btn_delete_Click(sender As System.Object, e As System.EventArgs) Handles btn_delete.Click
        If CheckRequired(co_cd, doc_mon) = False Then Exit Sub
        If MessageYesNo("[비용계산삭제]작업을 진행하시겠습니까?") <> MsgBoxResult.Yes Then Exit Sub

        Me.Open("far250_delete")
        Me.Open()
    End Sub
