...
Public Class QMG700
    ...
    Private Sub g20_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles g20.DragDrop
        ...
        If e.Data.GetDataPresent(DataFormats.FileDrop.ToString) Then
            ...
            If Not Me.Save("qmg700_f10") Then
                Exit Sub
            End If
    ...
    'Private Sub file_nm_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs)
    '    If e.Data.GetDataPresent(DataFormats.FileDrop.ToString) Then
    '        file_nm.Text = e.Data.GetData(DataFormats.FileDrop)(0)
    ...
    'Private Sub file_nm_DragOver(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs)
    '    If e.Data.GetDataPresent(DataFormats.FileDrop.ToString) Then
    '        e.Effect = DragDropEffects.Copy
    '    End If
    'End Sub
