...
Public Class PAC101
    ...
    Private Sub pac101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        m_Init = True
...
#Region " 1. Grid 컬럼 초기화 "
    ...
    Private Sub Init_Title()
        ...
        '1. 컬럼배열을 만든다
        Dim dSet As DataSet = Me.OpenDataSet("pac101_title")
...
#Region " 2. Display "
    ...
    Private Sub Disp_Data()
        Try
            ...
            g10.GridColumn("pay_ty").IsMasterKey = True
            ...
            g10.GridColumn("fr_pay").IsMasterData = True
            g10.GridColumn("to_pay").IsMasterData = True
            g10.GridColumn("dis_pay").IsMasterData = True
