...
#Region " 1. Grid 컬럼 초기화 "
    ...
    Private Sub Init_Title()
        ...
        Dim dSet As DataSet = Me.OpenDataSet("ESD202_Title", P)
...
#Region " 2. Display "
    ...
    Private Sub Disp_Data()
        Try
            ...
            g10.GridColumn("fr_sum").IsMasterData = True
            g10.GridColumn("to_sum").IsMasterData = True
...
#End Region
    ...
    Private Sub g10_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles g10.Click
        ...
        If r1.Checked Then
            ...
            Chart2.Titles(0).Text = ModelNm 'ToStr(g10.Text("fac_nm", Row)) & "(" & ToStr(g10.Text("grp_nm", Row)) & ")"
            Chart2.SeriesTemplate.Label.ResolveOverlappingMode = DevExpress.XtraCharts.ResolveOverlappingMode.Default
            For Col = 8 To g10.ColumnCount - 1
                If g10.ColumnTitle(Col).EndsWith("주") Then
                    Dim value As Double = 0
                    If ToStr(g10.Text(Col, Row)) = "" Then
                        value = 0
                    Else
