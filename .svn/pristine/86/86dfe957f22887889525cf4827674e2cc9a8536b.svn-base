Public Class PackingList_Mark
    ...
    Private Sub XrTableCell8_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles XrTableCell8.TextChanged
        Try
            ...
            If CInt(XrTableCell8.Text) = 0 Then
                XrTableCell8.Text = ""
            End If
    ...
    '0인 값들 지우기
    Private Sub XrTableCell7_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles XrTableCell7.TextChanged
        Try

            If CInt(XrTableCell7.Text) = 0 Then
                XrTableCell7.Text = ""
            End If
    ...
    End Sub
    '0인 값들 지우기
    Private Sub XrTableCell3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles XrTableCell3.TextChanged
        Try

            If CInt(XrTableCell3.Text) = 0 Then
                XrTableCell3.Text = ""
            End If
