...
Public Class MMB020
    ...
    Public Sub Open_Form()
        ...
        Dim dSet As DataSet = Me.OpenDataSet("mmb020_g10")
        Me.Disp_Data(dSet)
...
#Region " 1. g10_생성 "
    ...
    Private Sub Init_Title()
        ...
        g10.InsertArrayColumns("rmk", arr, "qty")
...
#Region " 1. g20_생성 "
    ...
    Private Sub Init1_Title()
        ...
        g20.InsertArrayColumns("rmk", arr, "qty")

    End Sub
    Private Sub Disp1_Data(ByVal dSet As DataSet)
            ...
            With g20
                ...
                For Each dRow In dSet.Tables(0).Rows
                    If s1 <> dRow("itm_cd") Then
                        ...
                        .Text("itm_cd", iRow) = ToStr(dRow("itm_cd"))
                        .Text("itm_nm", iRow) = ToStr(dRow("itm_nm"))
                        .Text("opt_cd", iRow) = ToStr(dRow("opt_cd"))
...
#End Region
    ...
    Private Sub g10_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles g10.DoubleClick
        ...
        p.Add("@plan_dtf", plan_dtf.Text)
        p.Add("@plan_dtt", plan_dtt.Text)
        p.Add("@itm_id", g10.Text("itm_id"))

        'Me.Open("mmb020_g20", p)

        Dim dSet As DataSet = Me.OpenDataSet("mmb020_g20", p)
        Me.Disp1_Data(dSet)
