...
Public Class FMA200
    ...
    Public Overrides Sub MenuButton_Click(ByVal mty As MenuType)
        Select Case mty
            ...
            Case MenuType.Save
                ...
                If MyBase.Save() Then
                    Dim saveID As String = g10.Text("fa_no")
                    MyBase.Open()
    ...
    '    Private Sub g30_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs)
    ...
    '    Private Sub g30_DragOver(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs)
    '        If e.Data.GetDataPresent(DataFormats.FileDrop.ToString) Then
