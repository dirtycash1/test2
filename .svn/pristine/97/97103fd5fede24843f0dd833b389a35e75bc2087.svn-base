...
Public Class DMD300
    ...
    '##             Procedure                                                            ##
    '######################################################################################
    Private Sub g10_ButtonPressed(ByVal sender As System.Object, ByVal columnName As System.String) Handles g10.ButtonPressed
    ...
    Private Sub FIleView()
        [Shared].FileDownLoad(g10.Text("file_nm"), , True)
    End Sub
End Class
