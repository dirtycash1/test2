...
Public Class MMR100
    ...
    Private Sub MMR100_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '  Me.Open()
    ...
    Private Sub Disp_Data()
        Try
            ...
            '/*************** 생산계획 품목 현황
            'Master 부분
            g20.GridColumn("itm_id").IsMasterKey = True
            g20.GridColumn("itm_bc").IsMasterKey = True

            g20.GridColumn("itm_cd").IsMasterData = True
            g20.GridColumn("itm_nm").IsMasterData = True
            g20.GridColumn("tot_qty").IsMasterData = True

            'Detail 부분
            g20.GridColumn("std_dt").IsDetailKey = True
            g20.GridColumn("plan_qty").IsDetailData = True
    ...
    Private Sub btn_mrp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_mrp.Click
        ...
        Dim Dset As DataSet = OpenDataSet("mmr100_batch")
        ...
        If Not IsEmpty(Dset) Then
            ...
            MessageInfo("결품예상 자재 산출이 완료 되었습니다")
