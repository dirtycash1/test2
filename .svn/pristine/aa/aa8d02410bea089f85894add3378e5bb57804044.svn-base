...
Public Class FAY730
    Private Sub FAY730_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region " Print "
    Private Sub Print()
        ...
        System7.ReportView.LoadView("FAY730", "", "fay730_g10", p) '합계잔액시산표출력
    End Sub
#End Region
