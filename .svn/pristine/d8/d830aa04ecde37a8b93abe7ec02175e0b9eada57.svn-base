...
Public Class FAY700
    Private Sub FAY700_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region " Print "
    Private Sub Print()
        ...
        System7.ReportView.LoadView("FAY700", "", "fay700_g10", p) '대차대조표출력
    End Sub
#End Region
