...
Public Class PME100
    ...
    Public Overrides Sub MenuButton_Click(ByVal mty As MenuType)
        ...
        Select Case mty
            ...
            Case MenuType.Delete
                ...
                If Me.Delete("pme100_f10") = ExcuteResult.Succeeded Then
                    Me.Open("pme100_f10")
                End If
            Case MenuType.Print
                DoPreview()
    ...
    Private Sub New_Form()
        'Try
        mo_id.Text = ""
        Me.OpenTrigger("pme100_g10")    'g10을 기점으로 OpenTrigger로 작동하는 모든 Control들 조회
    ...
    '    mo_mkcost.Text = sum_amt.ToString()
    '    mo_mkcust.Text = p_fac_nm
    ...
    Private Sub ent_id_TextChanged(sender As System.Object, oldValue As System.String)

    End Sub

    Private Sub EPanel1_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs)

    End Sub


    Private Sub ins_dt_TextChanged(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub mo_dis_TextChanged(sender As System.Object, e As System.EventArgs) Handles mo_disdt.TextChanged

    End Sub

    Private Sub EPanel2_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs) Handles EPanel2.Paint

    End Sub

    Private Sub mo_stepno_TextChanged(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub mo_regdt_TextChanged(sender As System.Object, e As System.EventArgs) Handles mo_regdt.TextChanged

    End Sub

    Private Sub mo_locinfo_TextChanged(sender As System.Object, oldValue As System.String) Handles mo_locinfo.TextChanged

    End Sub

    Private Sub mc_cd_TextChanged(sender As System.Object, e As System.EventArgs) Handles mc_cd.TextChanged

    End Sub

    Private Sub mo_id_TextChanged(sender As System.Object, oldValue As System.String) Handles mo_id.TextChanged
