...
Public Class WI_KU2120
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_ku2120_stts", p)
    ...
    Private Sub Max_NO()
        ' p/o 번호 채번
        ilc_no.CodeNo = "WI_KU2120"        'Function dbo.[fnCodeNo]안에 LEB100에 대한 코딩을 해야 한다
        ilc_no.CodeDateField = in_dt
    End Sub
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("wi_ku2120_confirm")

            p.Clear()
            p.Add("@ilc_no", ilc_no.Text)
            p.Add("@stts", "C")

            Me.Open("wi_ku2120_confirm", p)
        End If
    ...
    Private Sub Clear()
        ...
        Me.Open("wi_ku2120_head", p)
        Me.Open("wi_ku2120_body", p)
    End Sub
    ...
    Private Sub po_list()
        ...
        Me.Open("wi_ku2120_po", p)
    End Sub
    Private Sub cs_cd_TextChanged(ByVal sender As Object, ByVal oldValue As String) Handles cs_cd.TextChanged
        Me.po_list()
    End Sub

    Private Sub cur_cd_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cur_cd.TextChanged
        Me.po_list()
    End Sub
End Class
