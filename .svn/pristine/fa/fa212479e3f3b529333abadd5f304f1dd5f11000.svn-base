...
Public Class GAD110_HMME
    ...
    Public Sub Init_Form()
        g20.SelectRow = True
        g30.SelectRow = True
        If but.Properties.Items(but.SelectedIndex).Value = "0" Then
            EPanel2.Text = "사원정보"
            g20.BringToFront()
        Else
            EPanel2.Text = "일자"
    ...
    Private Sub Open_Form()
        Try
            ...
            If but.Properties.Items(but.SelectedIndex).Value = "0" Then
                EPanel2.Text = "사원정보"
                g20.BringToFront()
                Me.Open("gad110hmme_g20")
                Me.Open("gad110hmme_g10")

            Else
                EPanel2.Text = "일자"
                g30.BringToFront()
                Me.Open("gad110hmme_g30")
                Me.Open("gad110hmme_g10")
            End If
            GetStdTime()
        Catch ex As Exception
    ...
    Private Function ExistData() As Boolean
        ...
        Dim dSet As DataSet = OpenDataSet("gad110hmme_datacheck", p)
    ...
    Private Sub btn_calcu_Click(sender As System.Object, e As System.EventArgs) Handles btn_calcu.Click
    ...
    Private Sub sub_yn_CheckedChanged(sender As Object, e As System.EventArgs) Handles sub_yn.CheckedChanged
        ...
        With g10
            ...
            Try
                ...
                If ColumnName = "fr_tm" Or ColumnName = "to_tm" Or ColumnName = "atn_cd" Then
                    .Text("work_yn") = GetWorkChk(.Text("fr_tm"), .Text("to_tm"), .Text("atn_cd"))
                End If

                If ColumnName = "fr_tm" Or ColumnName = "to_tm" Or ColumnName = "dt_bc" Then
                    CallWorktime(RowIndex)
                End If
    ...
    Private Function GetWorkChk(FrTm As String, OutTm As String, AtnCd As String) As String
        GetWorkChk = ""
        If FrTm = "" Or FrTm = "" Or FrTm = "" Then Return ""
        Try
            Dim p As New OpenParameters
            p.Add("@bs_cd", bs_cd.Text)
            p.Add("@fr_tm", FrTm)
            ...
            Dim dSet As DataSet = OpenDataSet("gad110hmme_work_yn", p)
            Return DataValue(dSet, "work_yn")
    ...
    Private Function GetStdTime() As Boolean
        Try
            ...
            Dim p As New OpenParameters
            p.Add("@bs_cd", bs_cd.Text)
            dSetBaseTime = OpenDataSet("gad110hmme_unit_time", p)
            ...
            If Not IsEmpty(dSetBaseTime.Tables(1)) Then
                ...
                UnitTm = Unit '시간 계산단위(기본시단위:0.5시단위)
                UnitMin = Unit / 60.0 '시간 계산단위(기본시단위:30분단위)
    ...
    Private Sub CallWorkTime(iRow As Integer)
        ...
        With g10
            Try
                ...
                Dim work_hr As Double, std_hr As Double, _
                    ...
                    t1Hr As Double, t2Hr As Double, t3Hr As Double, t4Hr As Double, _
                ...
                frTm = .Text("fr_tm", iRow)
                toTm = .Text("to_tm", iRow)
                    ...
                    For gRow = 0 To baseTmRows.GetLength(0) - 1
                        ...
                        If TmBc = 근무시간_정상 Then
                            ...
                            Else
                                ...
                                std_hr = ((std_hr) / UnitTm) * UnitTm       '30분단위의 시간
                            End If
                        ...
                        Else
                            ...
                            tHr = ((tHr) / UnitTm) * UnitTm     '30분단위의 시간

                            If tHr < (UnitTm / 60) Then      '단위시간(ex:30분) 미만의 시간은 인정하지 않음
                                tHr = 0
                            End If
                ...
                PutTime("t2_hr", iRow, t2Hr)    '야간연장
                PutTime("t3_hr", iRow, t3Hr)    '휴일정상
                PutTime("t4_hr", iRow, t4Hr)    '휴일연장
                'PutTime("t5_hr", iRow, t5Hr)   '
                'PutTime("extn2_hr", iRow, extn2_hr)'심야연장
                'PutTime("extn3_hr", iRow, extn3_hr)'토요연장
                'PutTime("extn4_hr", iRow, extn4_hr)'휴일근무
                'PutTime("anight_hr", iRow, anight_hr) '심야시간
    ...
    Private Function HourDiff(frTm As String, toTm As String) As Double
