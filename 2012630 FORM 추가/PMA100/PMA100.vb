...
Public Class PMA100
    ...
    Private Sub pma100_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        prj_cd.CodeNo = "PMA100"
        prj_cd.CodeDateField = fr_dt
        ...
        g70.AllowAddRows = False    'Drag & Drop으로 만 신규파일 추가가능
        g70.AllowDeleteRows = False '임의로 DB에서만 삭제되면 FTP와의 동기화가 끊어진다 
    End Sub
    ...
    Public Overrides Sub Delete()
        Me.WorkSet("pma100_f10").DeleteRow()
        MyBase.Open()
    End Sub
...
#Region "FTP 관리"
    ...
    Private Sub g70_ButtonPressed(ByVal sender As Object, ByVal columnName As String) Handles g70.ButtonPressed
        Dim docCd As String = g70.Text("doc_cd")
        Dim fileID As String = g70.Text("file_id")
        Dim fileNm As String = g70.Text("file_nm")
        If fileNm = "" Then
            Exit Sub
        End If
        ...
        If columnName = "del" Then
            Try
                If [Shared].FileDelete(fileID, fileNm) = True Then
                    g70.AllowDeleteRows = True
                    g70.DeleteRow(g70.RowIndex)
                    g70.AllowDeleteRows = False
    ...
    Private Sub g70_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles g70.DragDrop
        If e.Data.GetDataPresent(DataFormats.FileDrop.ToString) Then
            ...
            For Each fileNm As String In e.Data.GetData(DataFormats.FileDrop)
                ...
                If Me._IsExists(g70, fileNm) Then
            ...
            For Each fullPath In e.Data.GetData(DataFormats.FileDrop)
                ...
                If fullPath <> "" Then
                    ...
                    g70.AddNewRow()
                    g70.Text("file_id") = FileID
                    g70.Text("file_nm") = fileNm
                    g70.Text("file_size") = f.Length.ToString
                End If
    ...
    Private Sub g70_DragOver(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles g70.DragOver
        If e.Data.GetDataPresent(DataFormats.FileDrop.ToString) Then
