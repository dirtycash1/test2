...
Public Class DMA100_SB
    ...
    Private Sub Me_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Me.NewForm()
        ''품목코드In 자동채번 설정
        'itm_id.CodeNo = "DMA100_SB"        'Function dbo.[fnCodeNo]안에 LEB100에 대한 코딩을 해야 한다
    ...
    Public Overrides Sub NewForm()
        ...
        Me.OpenTrigger("dma100_sb_g10")    'g10을 기점으로 OpenTrigger로 작동하는 모든 Control들 조회
...
#Region "FTP관리"
    ...
    Private Sub FileDelete_All()
        Try
            ...
            For Row As Integer = 0 To g90.RowCount - 1
                ...
                If [Shared].FileDelete(g90.Text("file_id"), g90.Text("file_nm"), , "DMA100_SB", False) = True Then
                    g90.DeleteRow(0)
    ...
    Private Sub FileAdd()
        ...
        If dialog.ShowDialog() = DialogResult.OK Then
            ...
            If Not MyBase.Save("dma100_sb_g90") Then
                '저장실패시 코드채번 취소
                Me.WorkSet("dma100_sb_g90").RecoverCodeNo()
                Exit Sub
            Else
            ...
            Try
                For Each fullPath As String In dialog.FileNames
                    ...
                    fileID = [Shared].FileUpload("", fullPath, "DMA100_SB", False)
                    ...
                    If fullPath <> "" Then
                        ...
                        '사용여부 자동체크 
                        For i = 0 To g90.RowCount - 1
                            g90.Text("stts", i) = "0"
                        Next
                        g90.Text("stts", g90.RowCount) = "1"
    ...
    Private Sub g90_ButtonPressed(ByVal sender As Object, ByVal columnName As String) Handles g90.ButtonPressed
        ...
        'MsgBox("g90_ButtonPressed")
        'MsgBox(ToStr(columnName))
    ...
    'Public Sub save_mmv100_2(chg_yn) '20150909 smk 품목별 매입처현황 저장 
    '    If chg_yn = "1" Then
    '        p.Clear()
    ...
    Private Sub g90_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles g90.DragDrop
        If e.Data.GetDataPresent(DataFormats.FileDrop.ToString) Then
            ...
            For Each fullPath As String In e.Data.GetData(DataFormats.FileDrop)
                ...
                Dim FileID As String = [Shared].FileUpload("", fullPath, "DMA100_SB", False)
