...
Public Class WP_EIS1011
    ...
    Private Sub OpenGrid()
        ...
        Me.Open("wp_eis1011_tab1_g10", param)
        Me.Open("wp_eis1011_tab2_g20", param)
    ...
    Private Sub OpenChart()
        Try
            ...
            'Dim dSet1 As DataSet = Me.OpenDataSet("wp_eis1010_tab1_chart1", param)
            'Dim dSet2 As DataSet = Me.OpenDataSet("wp_eis1010_tab2_chart1", param)
    ...
    '                    If dTable.Rows(i)("bc") = "10" Then
    '                        row(0) = dTable.Rows(i)("day_name").ToString + "1-Day"
    '                    ElseIf dTable.Rows(i)("bc") = "50" Then
    '                        row(0) = dTable.Rows(i)("day_name").ToString + "1-Day Circle"
    '                    ElseIf dTable.Rows(i)("bc") = "20" Then
    '                        row(0) = dTable.Rows(i)("day_name").ToString + " Soft"
    '                    ElseIf dTable.Rows(i)("bc") = "30" Then
    '                        row(0) = dTable.Rows(i)("day_name").ToString + "Color"
    '                        'ElseIf dTable.Rows(i)("bc") = "40" Then            '20141106 이우용이사님요청(Hard빼기)
    '                        ' row(0) = dTable.Rows(i)("day_name").ToString + "Hard"
    '                        'ElseIf dTable.Rows(i)("bc") = "B0" Then            '20141106 이우용이사님요청(약품빼기)
