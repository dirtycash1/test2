...
Public Class WP_EIS1030
    ...
    Private Sub OpenGrid()
        ...
        Me.Open("wp_eis1030_tab1_g10", param)
        Me.Open("wp_eis1030_tab2_g20", param)
    ...
    Private Sub OpenChart()
        Try
            ...
            Dim dSet1 As DataSet = Me.OpenDataSet("wp_eis1030_tab1_chart1", param)
            Dim dSet2 As DataSet = Me.OpenDataSet("wp_eis1030_tab2_chart1", param)
