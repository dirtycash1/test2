...
Public Class WP_EIS1070
    ...
    Private Sub OpenGrid()
        ...
        Me.Open("WP_EIS1070_tab1_g10", param)
        Me.Open("WP_EIS1070_tab2_g20", param)
    ...
    Private Sub OpenChart()
        Try
            ...
            'Dim dSet1 As DataSet = Me.OpenDataSet("WP_EIS1070_tab1_chart1", param)
            'Dim dSet2 As DataSet = Me.OpenDataSet("WP_EIS1070_tab2_chart1", param)

            'Me.Chart1(chart1_1, dSet1.Tables(0))
            'Me.Chart1(chart2_1, dSet2.Tables(0))

            LoadedGridDataDrawChart2(g10, chart1_2, "월")
    ...
    Private Sub g10_Click(sender As System.Object, e As System.EventArgs) Handles g10.Click
        ClickCreateChart2(g10, chart1_2, "월")
    End Sub
