...
Public Class WP_EIS1090
    ...
    Private Sub OpenGrid()
        ...
        Me.Open("WP_EIS1090_tab1_g10", param)
        Me.Open("WP_EIS1090_tab2_g20", param)
    ...
    Private Sub OpenChart()
        Try
            ...
            Dim dSet1 As DataSet = Me.OpenDataSet("WP_EIS1090_tab1_chart1", param)
            Dim dSet2 As DataSet = Me.OpenDataSet("WP_EIS1090_tab2_chart1", param)
