...
Public Class WP_EIS1110
    ...
    Private Sub OpenGrid()
        ...
        Me.Open("WP_EIS1110_tab1_g10", param)
        Me.Open("WP_EIS1110_tab2_g20", param)
        Me.Open("WP_EIS1110_tab3_g30", param)
    ...
    Private Sub OpenChart()
        Try
            ...
            'Dim dSet1 As DataSet = Me.OpenDataSet("WP_EIS1110_tab1_chart1", param)
            'Dim dSet2 As DataSet = Me.OpenDataSet("WP_EIS1110_tab2_chart1", param)
            ...
            LoadedGridDataDrawChart2(g30, chart3_2, "주 전")
            isHap = True
    ...
    Private Sub Chart1(ByVal ChartControls As DevExpress.XtraCharts.ChartControl, dTable As DataTable)
        ...
        If ChartControls.Name = "chart1_1" Or ChartControls.Name = "chart2_1" Or ChartControls.Name = "chart3_1" Then
            cnt_srs = 2
        Else
            cnt_srs = 1
        End If
    ...
    Private Sub g30_Click(sender As System.Object, e As System.EventArgs) Handles g30.Click
        ClickCreateChart2(g30, chart3_2, "주 전")
    End Sub
...
#End Region
    ...
    'Private Sub XtraTabPage2_Click(sender As Object, e As System.EventArgs) Handles XtraTabPage2.Click
    '    MsgBox("11")
    'End Sub

    'Private Sub XtraTabControl1_Move(sender As Object, e As System.EventArgs) Handles XtraTabControl1.Move
    '    MsgBox("11")
    'End Sub

    'Private Sub XtraTabPage2_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles XtraTabPage2.MouseClick
    '    MsgBox("11")
    'End Sub

    Private Sub XtraTabControl1_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles XtraTabControl1.MouseClick
        MsgBox("11")
    End Sub
End Class
