...
Public Class HRA100
        ...
        With g10
            For Row As Integer = 0 To g10.RowCount - 1
                ...
                If g10.Text("chk", Row) = "1" Then
                    ...
                    System7.ReportView.LoadView("HRA100", "", "hra100_print", p, Nothing, False)
                End If
            Next
        End With
    ...
    Private Sub btn_copy_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_copy.Click
        ...
        Dim dSet As DataSet = Me.OpenDataSet("hra100_copy", p)
    ...
    Private Sub f30_hire_dt_TextChanged(sender As System.Object, e As System.EventArgs) Handles f30_hire_dt.TextChanged
        f30_retr_dt2.Text = f30_hire_dt.Text    ' 지문 삭제일 = 사원증 발급일 
    End Sub
