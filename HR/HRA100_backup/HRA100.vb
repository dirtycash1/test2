...
Public Class HRA100
    ...
    Private Sub Print()
        ...
        System7.ReportView.LoadView("HRA100", "", "hra100_print", p) '', Nothing, False, 1, "1", "hra100_print_yhs2", p) ' 바로출력
    ...
    Private Sub reg_no_TextChanged(ByVal sender As Object, ByVal oldValue As String) Handles reg_no.TextChanged
        If reg_no.Text.Length > 7 Then
            ...
            End If
            MessageInfo(reg_no.Text.Replace("-", "").Substring(5, 1))
            Select Case reg_no.Text.Replace("-", "").Substring(5, 1)
                Case "1"
