...
Public Class WI_JA1175
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_JA1175_stts", p)
    ...
    Private Sub Max_NO()
        ' p/o 번호 채번
        chul_no.CodeNo = "WI_JA1175"        'Function dbo.[fnCodeNo]안에 LEB100에 대한 코딩을 해야 한다
    ...
    Private Function DeConFrim() As Boolean
        ...
        Else
            ...
            Me.Open("WI_JA1175_head", p)
            Me.Open("WI_JA1175_body", p)
