...
Public Class WI_JA1176A
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_JA1176A_stts", p)
    ...
    Private Function DeConFrim() As Boolean
        ...
        Else
            ...
            Me.Open("WI_JA1176A_head", p)
            Me.Open("WI_JA1176A_body", p)
