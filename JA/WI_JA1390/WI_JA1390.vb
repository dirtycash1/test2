...
Public Class WI_JA1390
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_JA1390_stts", p)
    ...
    Private Function DeConFrim() As Boolean
        ...
        Else
            ...
            Me.Open("WI_JA1390_head", p)
            Me.Open("WI_JA1390_body", p)
