...
Public Class WI_JA1420
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_ja1420_stts", p)
    ...
    Private Function ConFrim() As Boolean
        ...
        Else
            ...
            Me.Open("wi_ja1420_confirm", p)

            Me.Open("wi_ja1420_head", p)
            Me.Open("wi_ja1420_body", p)
    ...
    Private Function Check_Body() As Integer
        ...
        With g_body
            For i As Integer = 0 To .RowCount - 1
                ...
                Dim dSet As Data.DataSet = Me.OpenDataSet("wi_ja1420_stock", p)
    ...
    Private Function Check_Body2() As Integer   '체크시트No. 중복체크 160516smk

        Dim check As Decimal = 0
        With g_body
            For i As Integer = 0 To .RowCount
                g_body.Text("OVER_CHK", i) = 0
                For j As Integer = 0 To .RowCount
                    If (.Text("LOT_NO", i) = .Text("LOT_NO", j)) Then
                        .Text("OVER_CHK", i) = .ToDec("OVER_CHK", i) + 1
                    End If
                Next
            Next

            'For i As Integer = 0 To .RowCount
            '    If .ToDec("OVER_CHK", i) >= 2 Then
            '        MsgBox("중복 CHECK SHEET NO. : " & .Text("LOT_NO", i))
            '        Return 1
            '    End If
            'Next
