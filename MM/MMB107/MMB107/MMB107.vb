...
Public Class MMB107
    ...
    Private Sub but_tap_Click(sender As System.Object, e As System.EventArgs) Handles but_tap.Click
        ...
        For Row As Integer = 0 To g10.RowCount - 1
            If g10.Text("chk", Row) = "1" Then
                Print(g10.Text("dlv_no", Row), g10.Text("dlv_sq", Row), g10.Text("prt_cnt", Row), g10.Text("qty", Row))
            End If
        Next

    End Sub

    Private Sub Print(ByVal dlv_no As String, ByVal dlv_sq As String, ByVal prt_cnt As String, ByVal qty As Decimal)
    ...
    Private Sub but_tap_2_Click(sender As System.Object, e As System.EventArgs) Handles but_tap_2.Click
        For Row As Integer = 0 To g10.RowCount - 1
            If g10.Text("chk", Row) = "1" Then
                Print2(g10.Text("dlv_no", Row), g10.Text("dlv_sq", Row), g10.Text("prt_cnt", Row), g10.Text("qty", Row))
            End If
        Next
    End Sub
    Private Sub Print2(ByVal dlv_no As String, ByVal dlv_sq As String, ByVal prt_cnt As String, ByVal qty As Decimal)
