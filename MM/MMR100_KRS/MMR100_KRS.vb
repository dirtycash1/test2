...
Public Class MMR100_KRS


    Private Sub MMR100_KRS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '  Me.Open()
    ...
    Private Sub btn_mrp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_mrp.Click
        ...
        Dim Dset As DataSet = OpenDataSet("mmr100_krs_batch")
