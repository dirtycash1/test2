...
Public Class MMB310
    ...
    Private Sub Init_Title()
        ...
        g10.InsertArrayColumns(Nothing, arr, "tuip_qty")
    ...
    Private Sub Disp_Data()
        Try
            ...
            g10.GridColumn("ITM_NM").IsMasterKey = True
            ' g10.GridColumn("tuip_qty").IsMasterData = True


            'Detail 부분
            g10.GridColumn("PR_DT").IsDetailKey = True
            g10.GridColumn("tuip_qty").IsDetailData = True
