...
#Region " 1. Grid 컬럼 초기화 "
    ...
    Private Sub Init_Title()
        ...
        '1. 컬럼배열을 만든다
        Dim dSet As DataSet = Me.OpenDataSet("pab101_title")
...
#Region " 2. Display "
    ...
    Private Sub Disp_Data()
        Try
            ...
            g10.GridColumn("high_bc").IsMasterData = True
            g10.GridColumn("work_bc").IsMasterData = True
            g10.GridColumn("grp_bc").IsMasterData = True
            ...
            g10.GridColumn("out_amt").IsMasterData = True
...
#Region " 4. Display1 "
    ...
    Private Sub Disp1_Data()
        Try
            ...
            g20.GridColumn("grp_bc").IsMasterData = True
            g20.GridColumn("work_bc").IsMasterData = True
            g20.GridColumn("gen_ty").IsMasterData = True
            g20.GridColumn("duty_bc").IsMasterData = True
            'g20.GridColumn("high_bc").IsMasterData = True
            ...
            'g20.GridColumn("eat_amt").IsMasterData = True
            'g20.GridColumn("drv_amt").IsMasterData = True
            'g20.GridColumn("out_amt").IsMasterData = True
            'g20.GridColumn("tax_amt").IsMasterData = True
            'g20.GridColumn("tot_tax_amt").IsMasterData = True
...
#End Region
    ...
    Private Sub chk2_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk2.CheckedChanged
        ...
        g10.ColumnVisible("out_amt") = chk2.Checked

        g20.ColumnVisible("ot_amt") = chk2.Checked
        g20.ColumnVisible("eat_amt") = chk2.Checked
        g20.ColumnVisible("drv_amt") = chk2.Checked
        g20.ColumnVisible("out_amt") = chk2.Checked

    End Sub


    Private Sub EPanel1_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs) Handles EPanel1.Paint
