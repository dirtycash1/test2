...
#Region "메일보내기"
            ...
            With g10
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If .Text("chk", i) = "1" And .Text("email", i) <> "" Then
                        ...
                        Dim dSet As DataSet = Link.ReadDataSet("pab103_print_detail", p)

                        If (document Is Nothing) Then
                            formCd = PAB120._GetFileName("PAB103_Detail")
                            If (formCd = "") Then
                                Exit Sub
                            End If
                            Dim expression As ReportDocument = DirectCast(PAB120._LoadAssembly(formCd, "System7"), ReportDocument)
    ...
    '    body = PAB120.ReportView.LoadView("PAB103_Detail", "", "pab103_print_Sum", p, CrystalReportViewer, False)
    '    CrystalReportViewer.ReportSource = PAB120.ReportView.LoadView("PAB103_Detail", "", "pab103_print_Sum", p, CrystalReportViewer, False)
    '    CrystalReportViewer.RefreshReport()
    '    CrystalReportViewer.ExportReport()
    '    'body.Load(PAB120.ReportView.LoadView("PAB103_Detail", "", "pab103_print_Sum", p, CrystalReportViewer, False))
    '    'body.Load(CrystalReportViewer)
    '    'PAB120.ReportView.LoadView("PAB103_Detail", "", "pab103_print_Sum", p, CrystalReportViewer, false)
