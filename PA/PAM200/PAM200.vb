...
Public Class PAM200
    ...
    Private Sub Open_CompText()
        ...
        'Dim wSet As Frame7.WorkSet = Me.WorkSets("pam200_f10")
...
#Region " Event "
    ...
    Private Sub treeFields_MouseDown1(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles treeFields.MouseDown
        If e.Clicks <> 2 Then
            Return
        End If
