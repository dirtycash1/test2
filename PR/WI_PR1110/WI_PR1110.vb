...
Public Class WI_PR1110
    ...
    Private Sub Me_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Parameter.Login.LangNo = "1" Then
            but.Properties.Items(0).Description = "생산지시서"
            but.Properties.Items(1).Description = "품질CHECK_SHEET"

        Else
            but.Properties.Items(0).Description = "Directed Production"
            but.Properties.Items(1).Description = "Quality CHECK_SHEET"
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1110_stts", p)
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("WI_PR1110_confirm")

            p.Clear()
            p.Add("@job_no", job_no.Text)
            p.Add("@stts", "C")

            Me.Open("WI_PR1110_confirm", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1110_head", p)
        Me.Open("WI_PR1110_body", p)
    ...
    Private Sub popUP(s As String)
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_pr1110_hot_cd", p)
    ...
    Private Sub Print()
        ...
        Select but.Text
            Case "0"
                System7.ReportView.LoadView("WI_PR1110", "", "wi_pr1110_Print", p)
            Case "1"
                System7.ReportView.LoadView("WI_PR1110_S", "", "wi_pr1110_Print", p)
        End Select
    End Sub
