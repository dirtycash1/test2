...
Public Class WI_PR1111
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1111_stts", p)
    ...
    Private Function Check_deconfirm() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_pr1111_deconfirm", p)
    ...
    Private Sub Max_NO()
        ' p/o 번호 채번
        job_no.CodeNo = "WI_PR1111"        'Function dbo.[fnCodeNo]안에 LEB100에 대한 코딩을 해야 한다
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("WI_PR1111_confirm")

            p.Clear()
            p.Add("@job_no", job_no.Text)
            p.Add("@stts", "C")

            Me.Open("WI_PR1111_confirm", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1111_head", p)
        Me.Open("WI_PR1111_body", p)
    ...
    Private Sub popUP(s As String)
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1111_hot_cd", p)
