...
Public Class WI_PR1116
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1116_stts", p)
    ...
    Private Function Check_deconfirm() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1116_deconfirm", p)
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("WI_PR1116_confirm")

            p.Clear()
            p.Add("@job_no", job_no.Text)
            p.Add("@stts", "C")

            Me.Open("WI_PR1116_confirm", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1116_head", p)
        Me.Open("WI_PR1116_body", p)
    ...
    Private Sub popUP(s As String)
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1116_hot_cd", p)
    ...
    '    Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1116_rgdcd", p)
