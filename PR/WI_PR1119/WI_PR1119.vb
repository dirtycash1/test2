...
Public Class WI_PR1119
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1119_stts", p)
    ...
    Private Function Check_deconfirm() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1119_deconfirm", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1119_head", p)
        Me.Open("WI_PR1119_body", p)
    ...
    Private Sub g_body_ButtonPressed(sender As Object, columnName As String) Handles g_body.ButtonPressed
        If columnName = "chk" Then
            ...
            System7.ReportView.LoadView("WI_pr1119", "", "WI_pr1119_print", pp, )
    ...
    Private Sub popUP(s As String)
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1119_hot_cd", p)
    ...
    Private Sub gd_cd_TextChanged(sender As Object, oldValue As String) Handles gd_cd.TextChanged
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1119_rgdcd", p)
