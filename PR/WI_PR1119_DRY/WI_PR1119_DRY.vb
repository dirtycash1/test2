...
Public Class WI_PR1119_DRY
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1119_stts_DRY", p)
    ...
    Private Function Check_deconfirm() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1119_deconfirm_DRY", p)
    ...
    Private Function Del() As Boolean
        ...
        Else
            ...
            Me.Open("WI_PR1119_delete_DRY", p)
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("WI_PR1119_confirm")

            p.Clear()
            p.Add("@job_no", job_no.Text)
            p.Add("@stts", "C")

            Me.Open("WI_PR1119_confirm_DRY", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1119_head_DRY", p)
        Me.Open("WI_PR1119_body_DRY", p)
    ...
    Private Sub g_body_ButtonPressed(sender As Object, columnName As String) Handles g_body.ButtonPressed
        If columnName = "chk" Then
            ...
            pp.Add("@CH_LOT_NO", g_body.Text("CH_LOT_NO"))
            pp.Add("@JOB_SEQ", g_body.Text("JOB_SEQ"))
            'pp.Add("@chul_no", chul_no.Text)
            System7.ReportView.LoadView("WI_pr1119_DRY", "", "WI_pr1119_print_DRY", pp, )
    ...
    Private Sub popUP(s As String)
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1119_hot_cd_DRY", p)
    ...
    Private Sub hot_cd_TextChanged1(sender As Object, oldValue As String) Handles hot_cd.TextChanged
        Try
    ...
    Private Sub gd_cd_TextChanged(sender As Object, oldValue As String) Handles gd_cd.TextChanged
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1119_rgdcd_DRY", p)

        If Not IsEmpty(dSet) Then r_gd_cd.Text = DataValue(dSet)
    End Sub
End Class
