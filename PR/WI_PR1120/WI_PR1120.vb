...
Public Class WI_PR1120
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1120_stts", p)
    ...
    Private Sub Max_NO()
        ' p/o 번호 채번
        pr_no.CodeNo = "WI_PR1120"        'Function dbo.[fnCodeNo]안에 LEB100에 대한 코딩을 해야 한다
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("WI_PR1120_confirm")

            p.Clear()
            p.Add("@pr_no", pr_no.Text)
            p.Add("@stts", "C")

            Me.Open("WI_PR1120_confirm", p)
            stts.Text = "C"
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1120_head", p)
        Me.Open("WI_PR1120_body", p)
        Me.Open("WI_PR1120_body1", p)
        Me.Open("WI_PR1120_body2", p)
        Me.Open("WI_PR1120_body3", p)
        Me.Open("WI_PR1120_body4", p)
    ...
    Private Sub ng_qty_TextChanged(sender As Object, oldValue As String)
        Me.totQty()

    End Sub

    Private Sub pr_qty_TextChanged(sender As Object, oldValue As String)
        With g_body
            .UpdateRow()
            For i As Integer = 0 To .RowCount - 1
    ...
    Private Sub pr_jobno_TextChanged(sender As Object, oldValue As String)
        'Me.Clear()
    ...
    Private Sub setJobNO()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_pr1120_jobno", p)
        ...
        dSet = Me.OpenDataSet("WI_PR1120_bom", p)
    ...
    Private Sub gong_cd_TextChanged(sender As Object, e As System.EventArgs)
        setJobNO()
    End Sub

    Private Sub find_visible_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles find_visible.CheckedChanged
