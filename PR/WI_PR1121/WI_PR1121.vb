...
Public Class WI_PR1121
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1121_stts", p)
    ...
    Private Function Max_LOTNO() As String
        p.Clear()
        p.Add("@GD_NM", FAC_CD.Text + new_gdnm.Text)
        'p.Add("@FAC_CD", FAC_CD.Text)

        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1121_maxLOTNO", p)
        Dim stts As String = ""
    ...
    Private Sub setJobNO()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1121_jobno", p)
        ...
        dSet = Me.OpenDataSet("WI_PR1121_bom", p)
    ...
    Private Sub MIC_print_Click(sender As System.Object, e As System.EventArgs) Handles MIC_print.Click
        ...
        If lot_no.Text <> "" And stts.Text = "C" Then
            System7.ReportView.LoadView("WI_PR1121", "", "WI_PR1121_print", p, , True
                                        )
        Else
