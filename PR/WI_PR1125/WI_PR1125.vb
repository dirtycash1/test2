...
Public Class WI_PR1125
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1125_stts", p)
    ...
    Private Sub Max_NO()
        ' p/o 번호 채번
        pr_no.CodeNo = "WI_PR1125"        'Function dbo.[fnCodeNo]안에 LEB100에 대한 코딩을 해야 한다
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("WI_PR1125_confirm")

            p.Clear()
            p.Add("@pr_no", pr_no.Text)
            p.Add("@stts", "C")

            Me.Open("WI_PR1125_confirm", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1125_head", p)
        Me.Open("WI_PR1125_body", p)
        Me.Open("WI_PR1125_body1", p)
        Me.Open("WI_PR1125_body2", p)
        Me.Open("WI_PR1125_body3", p)
        Me.Open("WI_PR1125_body4", p)
        Me.Open("WI_PR1125_body5", p)
    ...
    Private Sub setJobNO()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1125_jobno", p)
        ...
        dSet = Me.OpenDataSet("WI_PR1125_bom", p)
