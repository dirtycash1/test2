...
Public Class WI_PR1126
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1126_stts", p)
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("WI_PR1126_confirm")

            p.Clear()
            p.Add("@pr_no", pr_no.Text)
            p.Add("@stts", "C")

            Me.Open("WI_PR1126_confirm", p)
    ...
    Private Function Check_deconfirm() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1126_deconfirm", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1126_head", p)
        Me.Open("WI_PR1126_body", p)
        Me.Open("WI_PR1126_body1", p)
        Me.Open("WI_PR1126_body2", p)
        Me.Open("WI_PR1126_body3", p)
        Me.Open("WI_PR1126_body4", p)
        Me.Open("WI_PR1126_body5", p)
    ...
    Private Function Max_LOTNO() As String
        Dim stts As String = "", rtn As String = ""

        With g_body
            .UpdateRow()
            For i As Integer = 0 To .RowCount - 1
                If .Text("GD_CD", i).Substring(0, 1).ToUpper = "B" Or .Text("GD_CD", i).Substring(0, 1).ToUpper = "A" Then
                    rtn = .Text("LOT_NO", i)
                    Exit For
                End If
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1126_maxLOTNO", p)
    ...
    Private Sub setJobNO()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1126_jobno", p)
        ...
        dSet = Me.OpenDataSet("WI_PR1126_bom", p)
    ...
    Private Sub g_body1_CellValueChanged(sender As Object, ColumnName As String, RowIndex As Integer, ByRef Value As Object)
