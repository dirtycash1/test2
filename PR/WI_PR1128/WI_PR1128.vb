...
Public Class WI_PR1128
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1128_stts", p)
    ...
    Private Sub Max_NO()
        ' p/o 번호 채번
        pr_no.CodeNo = "WI_PR1121"        'Function dbo.[fnCodeNo]안에 LEB100에 대한 코딩을 해야 한다
        pr_no.CodeDateField = pr_dt

        lot_no.Text = Max_LOTNO()

    End Sub

    Private Function Max_LOTNO() As String
        p.Clear()
        p.Add("@GD_NM", new_gdnm.Text)

        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1128_maxLOTNO", p)
        Dim stts As String = ""
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("WI_PR1128_confirm")

            p.Clear()
            p.Add("@pr_no", pr_no.Text)
            p.Add("@stts", "C")

            Me.Open("WI_PR1128_confirm", p)
    ...
    Private Function Check_deconfirm() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1128_deconfirm", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1128_head", p)
        Me.Open("WI_PR1128_body", p)
        Me.Open("WI_PR1128_body1", p)
        Me.Open("WI_PR1128_body2", p)
        Me.Open("WI_PR1128_body3", p)
        Me.Open("WI_PR1128_body4", p)
    ...
    Private Sub setJobNO()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1128_jobno", p)
        ...
        dSet = Me.OpenDataSet("WI_PR1128_bom", p)
