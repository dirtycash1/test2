...
Public Class WI_PR1135
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1135_stts", p)
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            'Me.Open("WI_PR1135_confirm")

            p.Clear()
            p.Add("@pr_no", pr_no.Text)
            p.Add("@stts", "C")

            Me.Open("WI_PR1135_confirm", p)
    ...
    Private Function Check_deconfirm() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1135_deconfirm", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_PR1135_head", p)
        Me.Open("WI_PR1135_body", p)
        Me.Open("WI_PR1135_body1", p)
        Me.Open("WI_PR1135_body2", p)
        Me.Open("WI_PR1135_body3", p)
        Me.Open("WI_PR1135_body4", p)
        Me.Open("WI_PR1135_body5", p)
    ...
    Private Sub totQty()
        ...
        pr_qty.Text = job_qty.ToDec - ng_qty.ToDec - sample_qty.ToDec
    ...
    Private Sub setJobNO()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1135_jobno", p)
        ...
        dSet = Me.OpenDataSet("WI_PR1135_bom", p)
    ...
    Private Sub SimpleButton1_Click(sender As System.Object, e As System.EventArgs) Handles SimpleButton1.Click
        ...
        p.Add("@pr_no", pr_no.Text)
        If lot_no.Text <> "" And
            gong_cd.Text = "25" Then
            If Mid(new_gdnm.Text, 1, 4) = "CS30" Or Mid(new_gdnm.Text, 1, 8) = "(UV)CS30" Then

                System7.ReportView.LoadView("WI_PR11352", "", "WI_PR1135_print2", p, )
            Else
                System7.ReportView.LoadView("WI_PR1135", "", "WI_PR1135_print", p, )
            End If
