...
Public Class WI_PR1230
    ...
    Private Sub g_list_DoubleClick(sender As Object, e As System.EventArgs) Handles g_list.DoubleClick
        ...
        Me.Open("wi_pr1230_head", p)
        Me.Open("wi_pr1230_body", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("wi_pr1230_head", p)
        Me.Open("wi_pr1230_body", p)
        'Me.Open("wi_pr1230_list", p)
        'Me.Open("wi_pr1230_list2", p)
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_pr1230_stts", p)
    ...
    Private Function Max_LOTNO() As String    '체크해 보기
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_pr1230_maxlotno", p)
        Dim stts As String = ""
    ...
    Private Sub setJobNO()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1230_jobno", p)
        ...
        dSet = Me.OpenDataSet("wi_pr1230_bom", p)
    ...
    ''        WI_PR1230.ReportView.LoadView("WI_PR1230", "", "WI_PR1121_print", p, , True
    ''                                    )
    ''    Else
    ...
    '                For i = 1 To qty
    '                    p.Add("@pr_num", num)
    '                    WI_PR1230.ReportView.LoadView("WI_PR1230", "", "WI_PR1230_print", p, , False)
    '                    num = num + 1
    '                Next
    '                p2.Add("@lot_no", lot_no.Text)
    '                p2.Add("@pr_no", pr_no.Text)
    '                p2.Add("@print_qty", print_qty.Text)
    '                Me.Open("wi_pr1230_print_qty", p2)
    '                Me.Open()
    '                print_qty.Text = ""
    '            Else
