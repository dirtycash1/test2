...
Public Class WI_PR1306
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1306_stts", p)
    ...
    Private Function DeConFrim() As Boolean
        ...
        Else
            ...
            Me.Open("WI_PR1306_head", p)
            Me.Open("WI_PR1306_body", p)
    ...
    Private Function Check_Body() As Integer
        ...
        With g_body
            For i As Integer = 0 To .RowCount - 1
                ...
                Dim dSet As Data.DataSet = Me.OpenDataSet("WI_PR1306_stock", p)
    ...
    Private Sub setJobNO()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_pr1306_set", p)
    ...
    Private Sub setJobNO2()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_pr1306_set2", p)
        Dim ll_row As Integer = 0
