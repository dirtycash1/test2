...
Public Class WP_PR3050
    ...
    Private Sub Init_Title()
        ...
        '1. 컬럼배열을 만든다
        Dim dSet As DataSet = Me.OpenDataSet("wp_pr3050_title")
        ...
        g10.InsertArrayColumns(Nothing, arr, "ng_qty")
    ...
    Private Sub Disp_Data()
        Try
            'Master 부분
            g10.GridColumn("ng_cd").IsMasterKey = True
            g10.GridColumn("ng_nm").IsMasterKey = True
            g10.GridColumn("ng_sum").IsMasterData = True
