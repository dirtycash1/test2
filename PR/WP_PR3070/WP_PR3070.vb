...
Public Class WP_PR3070
    Private Sub Me_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        With g10
            ...
            .GridColumn("NEW_GDCD").IsMasterKey = True
            ...
            ' .GridColumn("SAMPLE_QTY").IsDetailData = True
        End With
...
#Region " 1. Grid 컬럼 초기화 "
    ...
    Private Sub Init_Title()
        ...
        Dim dSet As DataSet = Me.OpenDataSet("wp_pr3070_title")
