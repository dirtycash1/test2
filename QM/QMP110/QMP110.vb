...
Public Class QMP110
    ...
    '        If g10.Text("reg_no", i) = "" Then
    '            g10.Text("reg_no", i) = reg_no.Text
    '        End If
    ...
    Private Sub Init_Title()
        ...
        '1. 컬럼배열을 만든다
        Dim dSet As DataSet = Me.OpenDataSet("qmp110_get_title")
        ...
        g10.InsertArrayColumns("tot_qty", arr, "bad_qty1")
    ...
    Private Sub Disp_Data()
        ...
        Try
            ...
            'Mapping정보에서 저장시참조로 저장
            'g10.GridColumn("fac_cd").IsMasterData = True
            'g10.GridColumn("wc_cd").IsMasterData = True
            'g10.GridColumn("mc_cd").IsMasterData = True
            'g10.GridColumn("work_dt").IsMasterData = True
            'g10.GridColumn("reg_no").IsMasterData = True
            'g10.GridColumn("prc_cd").IsMasterData = True
            ...
            g10.GridColumn("work_qty").IsMasterData = True
            g10.GridColumn("good_qty").IsMasterData = True
            g10.GridColumn("bad_qty").IsMasterData = True
            g10.GridColumn("out_qty").IsMasterData = True
            g10.GridColumn("tot_qty").IsMasterData = True


            'Detail 부분
            g10.GridColumn("bad_cd").IsDetailKey = True
            g10.GridColumn("bad_qty1").IsDetailData = True
