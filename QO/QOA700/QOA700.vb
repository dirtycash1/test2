...
Public Class QOA700
    ...
    Private Sub QOA700_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Function DocDelete() As Boolean
        ...
        If Delete("qoa700_g10", False) = ExcuteResult.Succeeded Then Return True
    End Function
    ...
    Private Function Save_Form3() As Boolean
        ...
        Try
            ...
            If Parameter.Login.RegId.ToString <> cid.Text Then
                Dim dSet As DataSet = Me.OpenDataSet("qoa700_f20")    'test_workset이 WorkSet에 등록되어있어야 한다
    ...
    Private Function Save_Form4(ByVal Getseq As String) As Boolean
        ...
        Try
            ...
            If Parameter.Login.RegId.ToString <> cid.Text Then
                Dim dSet As DataSet = Me.OpenDataSet("qoa700_f30")
                If dSet Is Nothing Then
                    Return True
                End If
    ...
    Private Sub g10_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles g10.Click
        If g10.RowCount <= 0 Then Exit Sub
        If com_no.Text <> "" Then Save("qoa700_g10")
