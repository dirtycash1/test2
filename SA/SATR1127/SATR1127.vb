...
Public Class SATR1127
    ...
    Private Sub Me_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load '첫오픈시, 행추가를 위함.
        ...
        p.Add("@emp_no", "")
        p.Add("@od_dt", "")
        Me.OpenDataSet("satr1127_g_multi", p)
        Me.Open()
    End Sub
            ...
            For i As Integer = 0 To g_multi.RowCount - 1
                ...
                Else
                    For Each dRow2 In dRows2
                        ...
                        'g_multi.Text("OD_DT", i) = od_dt.Text
                        'g_multi.Text("EMP_NO", i) = emp_no.Text
                        'g_multi.Text("EMP_NM", i) = emp_nm.Text
                    Next
                End If

                If g_multi.Text("GD_CD", i) = "" Then           ' Or g_multi.Text("CS_CD", i) = "" 
                ...
                Dim dSet3 As Data.DataSet = Me.OpenDataSet("satr1127_discount", p)
                ...
                For Each dRow3 In dRows3
                    ...
                    g_multi.Text("DISCOUNT_AMT", g_multi.RowIndex) = ToStr(g_multi.ToDec("OD_AMT", g_multi.RowIndex) * (dRow3("RATE_RT") / 100))
                Next
    ...
    Private Function wf_odno() As Integer
        ...
        For i As Integer = 0 To g_multi.RowCount - 1
            ...
            Dim dCnt As Data.DataSet = Me.OpenDataSet("satr1127_cnt", p)
            Dim dRow1 As DataRow, dRows1 As DataRowCollection
            ...
            Dim dSet As Data.DataSet = Me.OpenDataSet("satr1127_same_fc", p)
    ...
    Private Sub g_multi_AddedRow(sender As Object, RowIndex As Integer) Handles g_multi.AddedRow
        With g_multi
            For i As Integer = 0 To g_multi.RowCount - 1
                g_multi.Text("OD_DT", i) = od_dt.Text
                g_multi.Text("EMP_NO", i) = emp_no.Text
