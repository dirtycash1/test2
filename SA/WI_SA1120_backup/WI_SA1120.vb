...
Public Class WI_SA1120
    ...
    Private Sub od_gu_TextChanged(sender As Object, e As System.EventArgs) Handles od_gu.TextChanged
        Me.setPrice("")
        If od_gu.Text = "CD05204" Or od_gu.Text = "CD05205" Then
    ...
    Private Sub sal_cust_TextChanged(sender As System.Object, oldValue As System.String) Handles sal_cust.TextChanged
