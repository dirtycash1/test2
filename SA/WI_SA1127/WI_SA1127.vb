...
Public Class WI_SA1127
    ...
    Private Sub Clear()
        ...
        p.Add("@confirm_gu", "N")
        p.Add("@stts", "A")    '처음 조회시 상태값 "신규"
        p.Add("@hcode_yn", "%")

        If fr_od_no.Text = "" Then
            p.Add("@fr_od_no", "100")
        Else
            p.Add("@fr_od_no", fr_od_no.Text)
        End If

        If to_od_no.Text = "" Then
            p.Add("@to_od_no", "999999999999")
        Else
            p.Add("@to_od_no", to_od_no.Text)
        End If

        Me.Open("WI_SA1127_multi", p)
    ...
    Private Sub Preview()
        ...
        '하드렌즈 제외 
        If hcode_yn.Text = "1" Then
            p.Add("@hcode_yn", "X")
        Else
            '제외안하면 전체조회니깐 조건없이 조회해야함.
            p.Add("@hcode_yn", "%")
        End If
    ...
    Private Sub Max_no()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_SA1127_maxno", p)
    ...
    Private Sub Max_no1()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_SA1127_maxno1", p)
