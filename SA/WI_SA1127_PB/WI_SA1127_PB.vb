...
Public Class WI_SA1127_PB
    ...
    Private Sub Max_no()
        p.Clear()
        p.Add("@pgid", "WI_SA1121_PB")
        p.Add("@date", confirm_dt.Text)

        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_SA1127_maxno_PB", p)
    ...
    Private Sub Max_no1()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_SA1127_maxno1_PB", p)
