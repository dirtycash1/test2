...
Public Class WI_SA1140
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1140_stts", p)
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("확인 하시겠습니까?", Nothing, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = MsgBoxResult.No Then
            Exit Function
        Else
            '20160912 smk 출하일자 UPDATE 
            p.Clear()
            p.Add("@ot_no", ot_no.Text)
            p.Add("@ot_dt", ot_dt.Text)
            Me.Open("wi_sa1140_ot_dt", p)

            p.Clear()
            p.Add("@ot_no", ot_no.Text)
            p.Add("@stts", "C")

            Me.Open("wi_sa1140_confirm", p)
            ...
            p.Clear()
            p.Add("@ot_no", ot_no.Text)
            Me.Open("wi_sa1140_head", p)

            p.Clear()
            p.Add("@ot_no", ot_no.Text)
            Me.Open("wi_sa1140_body", p)
    ...
    Private Sub find_list2()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1140_set_head", p)
        ...
        If Not IsEmpty(dSet) Then
            ...
            For Each dRow In dRows
                ...
                wh_cd.Text = "S001"
                ship_cs_cd.Text = ToStr(dRow("SHIP_CS_CD"))   '160810 배송거래처
                ship_cs_nm.Text = ToStr(dRow("SHIP_CS_NM"))
    ...
    Private Sub od_list()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1140_set_body", p)
        If Not IsEmpty(dSet) Then
            With g_body
    ...
    Private Sub ot_no_TextChanged(sender As Object, oldValue As String) Handles ot_no.TextChanged
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1140_otcnt", p)
    ...
    Private Sub but_prt_Click(sender As System.Object, e As System.EventArgs) Handles but_prt.Click
        ...
        System7.ReportView.LoadView("WI_SA1140", "", "wi_sa1140_print", p, Nothing, False, 1, "sub", "wi_sa1140_print_sub", p1) ' 바로출력
