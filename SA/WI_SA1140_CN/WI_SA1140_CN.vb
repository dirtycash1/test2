...
Public Class WI_SA1140_CN
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1140_stts_CN", p)
    ...
    Private Sub Max_NO()
        ' 전표 번호 채번
        ot_no.CodeNo = "WI_SA1140_CN"        'Function dbo.[fnCodeNo]안에 LEB100에 대한 코딩을 해야 한다
    ...
    Private Function ConFrim() As Boolean
        ...
        Else
            ...
            Me.Open("wi_sa1140_confirm_CN", p)
            ...
            p.Clear()
            p.Add("@ot_no", ot_no.Text)
            Me.Open("wi_sa1140_head_CN", p)

            p.Clear()
            p.Add("@ot_no", ot_no.Text)
            Me.Open("wi_sa1140_body_CN", p)
    ...
    Private Sub find_list2()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1140_set_head_CN", p)
    ...
    Private Sub od_list()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1140_set_body_CN", p)
        If Not IsEmpty(dSet) Then
            With g_body
    ...
    Private Function Check_Sebal() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1140_sebal_CN", p)
        Dim stts As String = "S"
    ...
    Private Function wf_update_lotno() As Integer
        ...
        With g_body
            For i As Integer = 0 To .RowCount - 1
                ...
                Me.Open("wi_sa1140_lotno_update_CN", p)
            Next
        End With
    End Function
    ...
    Private Sub ot_no_TextChanged(sender As Object, oldValue As String) Handles ot_no.TextChanged
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1140_otcnt_CN", p)
    ...
    Private Sub but_prt_Click(sender As System.Object, e As System.EventArgs) Handles but_prt.Click
        ...
        System7.ReportView.LoadView("WI_SA1140_CN", "", "wi_sa1140_print_CN", p, Nothing, False, 1, "sub", "wi_sa1140_print_sub_CN", p1) ' 바로출력
