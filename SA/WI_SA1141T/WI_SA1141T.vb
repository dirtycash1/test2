...
Public Class WI_SA1141T
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_SA1141T_stts", p)
    ...
    Private Function DeConFrim() As Boolean
        ...
        Else
            ...
            p.Clear()
            p.Add("@ot_no", ot_no.Text)
            Me.Open("WI_SA1141T_head", p)
            p.Clear()
            p.Add("@ot_no", ot_no.Text)
            Me.Open("WI_SA1141T_body", p)
    ...
    Private Sub find_list2()
        ...
        p.Clear()
        p.Add("@od_no", g_list2.Text("PR_NO", g_list2.RowIndex))

        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_SA1141T_set_head", p)
    ...
    Private Sub od_list()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_SA1141T_set_body", p)
        If Not IsEmpty(dSet) Then
            With g_body
                ...
                For Each dRow In dRows
                    ...
                    .Text("OT_QTY", iRow) = ToDec(dRow("OD_QTY"))
                    .Text("OT_PRI", iRow) = ToDec(dRow("OD_PRI"))
                    .Text("OT_AMT", iRow) = ToDec(dRow("OD_QTY")) * ToDec(dRow("OD_PRI"))
    ...
    Private Sub Setitem_Rate()
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_SA1141T_set_rate", p)
    ...
    '    With g_body
    '        For i As Integer = 0 To .RowCount - 1
    '            .Text("OT_AMT", i) = .ToDec("OT_QTY", i) * .ToDec("OT_PRI", i)
    '            .Text("WON_AMT", i) = (.ToDec("OT_QTY", i) * .ToDec("OT_PRI", i)) * ld_rate
    '        Next
    '    End With
