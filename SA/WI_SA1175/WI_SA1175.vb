...
Public Class WI_SA1175
    ...
    Private Function ConFrim() As Boolean
        ...
        If MessageYesNo("세금계산서발행 취소 하시겠습니까?") = MsgBoxResult.No Then
            Exit Function
        Else
            If MyBase.Save() Then
    ...
    Private Sub g_list_AfterMoveRow(sender As System.Object, PrevRowIndex As System.Int32, RowIndex As System.Int32) Handles g_list.AfterMoveRow
        Try
            'MsgBox(g_list.Text("DOC_NO", RowIndex))
            If g_list.Text("DOC_NO", RowIndex) = "" Then
