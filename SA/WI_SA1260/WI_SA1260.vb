...
Public Class WI_SA1260
    ...
    Public Overrides Sub MenuButton_Click(ByVal mty As MenuType)
        Select Case mty
            ...
            Case MenuType.Print
                ...
                pp.Add("@job_no", job_no.Text)

                System7.ReportView.LoadView("WI_SA1260", "", "wi_sa1260_Print", pp, Nothing, True, 1, "detail", "wi_sa1260_Print2", pp)
    ...
    Private Function Check_Stts() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("WI_SA1260_stts", p)
    ...
    Private Function Check_deconfirm() As String
        ...
        Dim dSet As Data.DataSet = Me.OpenDataSet("wi_sa1260_deconfirm", p)
    ...
    Private Sub Clear()
        ...
        Me.Open("WI_SA1260_head", p)
        Me.Open("WI_SA1260_body", p)
        Me.Open("WI_SA1260_body1", p)
