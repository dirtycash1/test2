...
Public Class WI_SA1261
    ...
    Private Sub set_SATR1113()

        p.Clear()
        p.Add("@pr_jobno", pr_jobno.Text)
        Dim dSet As Data.DataSet

        dSet = Me.OpenDataSet("WI_SA1261_set", p)
        ...
        If Not IsEmpty(dSet) Then
            ...
            With g_body1
                ...
                For Each dRow In dRows
                    ...
                    .Text("JOB_QTY", ll_row1) = ToStr(dRow("QTY"))
                    .Text("G_QTY", ll_row1) = ToStr(dRow("PR_QTY"))
                    .Text("QTY", ll_row1) = ToStr(dRow("QTY"))  '실수량
                    .Text("S_GDCD", ll_row1) = ToStr(dRow("S_GDCD"))
                    .Text("STOCK_QTY", ll_row1) = ToStr(dRow("STOCK_QTY")) '현재고 조회
    ...
    Private Sub find_list2()
        ...
        set_SATR1113() '20150317 SMK (SATR1113조회)
