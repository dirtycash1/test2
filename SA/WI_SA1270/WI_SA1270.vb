...
Public Class WI_SA1270
    ...
    Private Sub btn_find_Click(sender As System.Object, e As System.EventArgs)

        If find_from.Text = "" Then
            MsgBox("계획년월을 확인하세요.!")
            Return
        End If
