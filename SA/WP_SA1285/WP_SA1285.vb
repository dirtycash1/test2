            ...
            With g10
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If .Text("g10_chk", i) = "1" And .Text("email", i) <> "" Then           '체크가 된 것만 메일 보내기. 
                        ...
                        'userid = System.Text.Encoding.UTF8.GetBytes("cs@interojo.com")
                        'userpw = System.Text.Encoding.UTF8.GetBytes("inter1025")
                        ...
                        'Message.From = New MailAddress("jikwon@interojo.com")
