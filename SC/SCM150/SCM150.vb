...
Public Class SCM150
    ...
    Private Sub Open_TreeView2()

        TreeView2.BeginUpdate()

        Call TreeView2.Nodes.Clear()

        Dim p As New OpenParameters
        p.Add("@system_cd", system_cd.Text)
        p.Add("@mdl_cd", mdl_cd.Text)
        'p.Add("@menu_nm", menu_nm.Text)
        p.Add("@rol_cd", rol_cd.Text)

        Dim dSet As DataSet = OpenDataSet("scm150_menu_tree", p)
        ...
        For Each dRow In dRows
            ...
            If parent = "" Then
                tNode = TreeView2.Nodes.Add(Nm)
                tNode.Tag = Id
                tNode.ImageIndex = 0
                tNode.ForeColor = Color.Red

                If chk_expand2.Checked Then tNode.Expand()
            ...
            Else
                tNode = Me._FindNode(TreeView2.Nodes, parent)
                If Not IsNothing(tNode) Then
        ...
        ExpandTreeView(chk_expand2, TreeView2)

        TreeView2.EndUpdate()

        'Focus Node를 제일 위로 옮긴다
        If Not IsNothing(TreeView2.Nodes) Then
    ...
    '    Private Sub g10_CellValueChanged(ByVal sender As Object, ByVal colName As String, ByVal RowIndex As Integer, ByRef Value As Object) Handles g10.CellValueChanged
    Private Sub g10_CellValueChanging(ByVal sender As Object, ByVal colName As String, ByVal RowIndex As Integer, ByRef Value As Object) Handles g10.CellValueChanging
        With g10
    ...
    Private Sub chk_expand_Change(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_expand.CheckedChanged, chk_under.CheckedChanged
        TreeView1.BeginUpdate()
        Me.ExpandTreeView(chk_expand, TreeView1)
        TreeView1.EndUpdate()
    End Sub

    Private Sub chk_expand2_Change(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_expand2.CheckedChanged
        TreeView2.BeginUpdate()
        Me.ExpandTreeView(chk_expand2, TreeView2)
        TreeView2.EndUpdate()
    End Sub
